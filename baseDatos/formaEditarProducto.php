			...
			<form action="./editarProducto.php" method="post" enctype='multipart/form-data' class="needs-validation" novalidate>
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input type="number" name="precio" placeholder="Escribe el precio" class="form-control" step="0.01" required="required" value="<?php echo $producto['precio']; ?>">
						<div class="invalid-feedback">
				          El campo es requerido.
				        </div>
					</div>
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input type="file" name="urlImagen" placeholder="Selecciona la imagen" class="form-control">
						<div class="invalid-feedback">
				          El campo es requerido.
				        </div>
					</div>
