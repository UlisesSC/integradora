			...
			<form action="./revisaPasswordCliente2.php" method="post" class="needs-validation" novalidate>
				<div class="row">
					...
					<div class="col-md-12 form-group" align="left" style="font-family: Berlin Sans FB; font-size: 20px;">
						...
						<input type="username" name="username" id="username" placeholder="Escribe el usuario" class="form-control" maxlength="30" value="<?php echo (isset($username) ? $username : ""); ?>" required="required" >
